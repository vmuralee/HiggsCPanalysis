...
int main(int argc, char * argv[]) {
 ...
 // end of Sych tree
  ...
  for (int iF=0; iF<nTotalFiles; ++iF) {
	...
	if (analysisTree.tau_byTightIsolationMVArun2017v2DBoldDMwLT2017[it] < 0.5) continue;//*applied tight criteria after selecting index pair
